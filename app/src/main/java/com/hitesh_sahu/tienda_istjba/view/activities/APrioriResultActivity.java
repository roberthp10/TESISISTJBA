...
import com.hitesh_sahu.tienda_istjba.util.Animatrix;
        ...
        if (id == R.id.action_save) {
            ...
            if (barChart.saveToGallery("AprioriResult.jpg", 85)) {
                Snackbar.make(getWindow().getDecorView().findViewById(android.R.id.content),
                        "Gráfico guardado en la tarjeta SD", Snackbar.LENGTH_LONG)
                        .setAction("Accion", null).show();
            } else {
                Snackbar.make(getWindow().getDecorView().findViewById(android.R.id.content),
                        "No se pudo guardar la imagen", Snackbar.LENGTH_LONG)
                        .setAction("Accion", null).show();
            }
