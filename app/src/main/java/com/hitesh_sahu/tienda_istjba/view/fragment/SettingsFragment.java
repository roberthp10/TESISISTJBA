...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Acerca de la aplicación Ventas ISTJBA");
        ...
        if (PreferenceHelper.getPrefernceHelperInstace().getBoolean(
            ...
            submitLog.setText("Desactivar");
        } else {
            submitLog.setText("Permitir");
        }
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        emailIntent.putExtra(android.content.Intent.EXTRA_TEXT,
                                "Me interesaria obtener un sistema parecido a este, que se adapte a mi negocio.");
